...
"
  ...
  } else if (parameter == "3a") {

    program <- "
  # Read the dataset
  dataset <- read.csv(\"C:/Users/Aditi/Documents/RStudio Practicals/Social_Network_Ads.csv\")
  print(dataset)
